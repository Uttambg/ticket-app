...
//   const [showSignUp, setShowSignUp] = useState<boolean>(false); // State for showing sign-up form
...
//           onClick={handleSignUpClick} // Navigate to sign-up form
//         >
//           Sign up free
//         </button>
//       </div>
...
const Login: React.FC = () => {
  ...
  // Function to handle Apple login click
  const appleOpen = () => {
    ...
    window.location.href = appleUrl; // Redirect to Apple OAuth URL
  };
